...
const seeds: Seed[] = [
  ...
  { title: 'Utilities, internet, and city taxes: your real monthly costs beyond rent', dek: 'The full picture of what an Amsterdam home costs per month beyond the rent itself.', slug: 'utilities-and-costs', category: 'Finance & Work', readMinutes: 7 },
  { title: 'The 30% ruling in 2026 and what it means for your rent budget', dek: 'How the ruling works now, and what it does to what you can afford.', slug: '30-percent-ruling', category: 'Finance & Work', readMinutes: 8 },
  { title: 'Income requirements for renting: what agencies really check', dek: 'The three-times-rent rule of thumb, and how strict it really is.', slug: 'income-requirements', category: 'Finance & Work', readMinutes: 6 },
  { title: 'Opening a Dutch bank account fast, even before you land', dek: 'The routes to a working Dutch account, including options you can start from abroad.', slug: 'dutch-bank-account', category: 'Finance & Work', readMinutes: 5 },
  { title: 'Dutch health insurance: how to pick in one evening', dek: 'A simple way to choose a policy without losing a weekend to it.', slug: 'dutch-health-insurance', category: 'Finance & Work', readMinutes: 7 },
  { title: 'Highly skilled migrant salary thresholds, explained simply', dek: 'The numbers that matter for the HSM permit, in plain language.', slug: 'hsm-thresholds', category: 'Finance & Work', readMinutes: 7 },
  { title: 'Going freelance in the Netherlands: ZZP basics for expats', dek: 'What ZZP means, and the first steps to working for yourself here.', slug: 'freelance-zzp', category: 'Finance & Work', readMinutes: 8 },
