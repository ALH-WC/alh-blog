import { CITY_AREAS, CITY_REST_PATH, LINE_A10, LINE_AMSTEL, MAP_VIEWBOX, PARKS_PATH, WATER_PATH } from '../lib/cityMap';
import styles from './CityMap.module.css';

// The article hero: the neighbourhood in question carries its full palette
// colour, everything else falls back to a pale tint, and the water, parks and
// the A10 keep the reader oriented. Deliberately a server component kept apart
// from the interactive CityMap, so the article pages ship no map JavaScript.
