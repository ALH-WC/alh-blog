...
- Boutique statement (home + renting): "Amsterdam's boutique housing agency, / run by local expats." Line one NEVER breaks on desktop (max-width none); on phones the break dissolves.
