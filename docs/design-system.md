...
- **4.13 Guide band**: white with top/bottom hairlines, Mixta title + bronze ↗, the signature reveal kept. No sand fill. It is the LAST band before the footer on EVERY company page, the homepage and /renting included: one identical guide gateway sitewide. The homepage's guide module (three newest articles) keeps its rows but carries NO link of its own; the band is the only guide link.
